...
@section('content')
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="gambar" class="flex flex-col items-center justify-center w-full h-32 border-2 border-white/10 border-dashed rounded-lg cursor-pointer bg-white/5 hover:bg-white/10 transition-colors group">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-slate-400">Upload Foto (Max 2MB)</p>
                                </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <div class="relative flex-1">
                                ...
                                <input type="text" name="kode_barcode" id="kode_barcode" class="glass-input w-full pl-10" placeholder="Scan atau ketik kode barcode" value="{{ old('kode_barcode') }}" required>
                            </div>
    ...
    <script>
        ...
        document.addEventListener('code-scanned', function(e) {
            ...
            // Play success sound if desired (optional)
        });
    </script>
    @endpush
@endsection
